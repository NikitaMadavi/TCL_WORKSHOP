...
set_output_delay -clock [get_clocks yet_to_decide22] -min -fall -source_latency_included 103 [get_ports aclk*]
...
set_output_delay -clock [get_clocks yet_to_decide23] -min -fall -source_latency_included 104 [get_ports aclk_en*]
...
set_output_delay -clock [get_clocks yet_to_decide24] -min -fall -source_latency_included 105 [get_ports dbg_freeze*]
...
set_output_delay -clock [get_clocks yet_to_decide25] -min -fall -source_latency_included 106 [get_ports dbg_i2c_sda_out*]
...
set_output_delay -clock [get_clocks yet_to_decide26] -min -fall -source_latency_included 107 [get_ports dbg_uart_txd*]
...
set_output_delay -clock [get_clocks yet_to_decide27] -min -fall -source_latency_included 108 [get_ports dco_enable*]
...
set_output_delay -clock [get_clocks yet_to_decide28] -min -fall -source_latency_included 109 [get_ports dco_wkup*]
...
set_output_delay -clock [get_clocks yet_to_decide29] -min -fall -source_latency_included 110 [get_ports dmem_addr*]
...
set_output_delay -clock [get_clocks yet_to_decide30] -min -fall -source_latency_included 111 [get_ports dmem_cen]
...
set_output_delay -clock [get_clocks yet_to_decide31] -min -fall -source_latency_included 112 [get_ports dmem_din*]
...
set_output_delay -clock [get_clocks yet_to_decide32] -min -fall -source_latency_included 113 [get_ports dmem_wen*]
...
set_output_delay -clock [get_clocks yet_to_decide33] -min -fall -source_latency_included 114 [get_ports irq_acc*]
...
set_output_delay -clock [get_clocks yet_to_decide34] -min -fall -source_latency_included 115 [get_ports lfxt_enable*]
...
set_output_delay -clock [get_clocks yet_to_decide35] -min -fall -source_latency_included 116 [get_ports lfxt_wkup*]
...
set_output_delay -clock [get_clocks yet_to_decide36] -min -fall -source_latency_included 117 [get_ports mclk*]
...
set_output_delay -clock [get_clocks yet_to_decide37] -min -fall -source_latency_included 118 [get_ports dma_dout*]
...
set_output_delay -clock [get_clocks yet_to_decide38] -min -fall -source_latency_included 119 [get_ports dma_ready]
...
set_output_delay -clock [get_clocks yet_to_decide39] -min -fall -source_latency_included 120 [get_ports dma_resp]
...
set_output_delay -clock [get_clocks yet_to_decide40] -min -fall -source_latency_included 121 [get_ports per_addr*]
...
set_output_delay -clock [get_clocks yet_to_decide41] -min -fall -source_latency_included 122 [get_ports per_din*]
...
set_output_delay -clock [get_clocks yet_to_decide42] -min -fall -source_latency_included 123 [get_ports per_en]
...
set_output_delay -clock [get_clocks yet_to_decide43] -min -fall -source_latency_included 124 [get_ports per_we*]
...
set_output_delay -clock [get_clocks yet_to_decide44] -min -fall -source_latency_included 125 [get_ports pmem_addr*]
...
set_output_delay -clock [get_clocks yet_to_decide45] -min -fall -source_latency_included 126 [get_ports pmem_cen]
...
set_output_delay -clock [get_clocks yet_to_decide46] -min -fall -source_latency_included 127 [get_ports pmem_din*]
...
set_output_delay -clock [get_clocks yet_to_decide47] -min -fall -source_latency_included 128 [get_ports pmem_wen*]
...
set_output_delay -clock [get_clocks yet_to_decide48] -min -fall -source_latency_included 129 [get_ports puc_rst*]
...
set_output_delay -clock [get_clocks yet_to_decide49] -min -fall -source_latency_included 130 [get_ports smclk*]
...
set_output_delay -clock [get_clocks yet_to_decide50] -min -fall -source_latency_included 131 [get_ports smclk_en*]